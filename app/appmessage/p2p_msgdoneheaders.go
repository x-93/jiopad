...
// MsgDoneHeaders implements the Message interface and represents a karlsen
...
// NewMsgDoneHeaders returns a new karlsen DoneIBDBlocks message that conforms to the
// Message interface.
