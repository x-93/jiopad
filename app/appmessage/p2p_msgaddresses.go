...
// karlsen Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a karlsen
// Addresses message.
...
// NewMsgAddresses returns a new karlsen Addresses message that conforms to the
