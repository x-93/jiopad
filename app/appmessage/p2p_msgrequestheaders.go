...
// MsgRequestHeaders implements the Message interface and represents a karlsen
...
// NewMsgRequstHeaders returns a new karlsen RequestHeaders message that conforms to the
