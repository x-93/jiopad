...
// MsgRequestTransactions implements the Message interface and represents a karlsen
...
// NewMsgRequestTransactions returns a new karlsen RequestTransactions message that conforms to
