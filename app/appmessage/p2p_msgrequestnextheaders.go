...
// MsgRequestNextHeaders implements the Message interface and represents a karlsen
...
// NewMsgRequestNextHeaders returns a new karlsen RequestNextHeaders message that conforms to the
// Message interface.
