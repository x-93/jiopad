...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a karlsen
...
// NewMsgDoneBlocksWithTrustedData returns a new karlsen DoneBlocksWithTrustedData message that conforms to the
// Message interface.
