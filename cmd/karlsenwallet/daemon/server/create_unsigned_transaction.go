...
// By having at least 0.2KLS in the change output we make sure that every transaction with send value >= 0.2KLS
...
const minChangeTarget = constants.SompiPerKarlsen / 5
