...
var devnetGenesisHash = externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
	0x1b, 0x9b, 0xe8, 0x0e, 0xd3, 0x60, 0xb5, 0x1c,
	0x95, 0xed, 0x15, 0x1d, 0x0f, 0x08, 0x03, 0x5c,
	0x8e, 0xc0, 0x1e, 0x86, 0xea, 0xb3, 0x14, 0x49,
	0xe3, 0xe4, 0x96, 0xe0, 0x96, 0xb1, 0xee, 0x43,
})
...
var devnetGenesisBlock = externalapi.DomainBlock{
	Header: blockheader.NewImmutableBlockHeader(
		...
		externalapi.NewDomainHashFromByteArray(muhash.EmptyMuHashHash.AsArray()),
		0x11e9db49828,
		0x1e21bc1c, // Bits with ~testnet-like difficulty for slow devnet start
		0x48e5e,
		0,
		0,
		big.NewInt(0),
