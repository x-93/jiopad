...
const (
	...
	defaultSubsidyGenesisReward                    = 1 * constants.SompiPerKarlsen
	defaultPreDeflationaryPhaseBaseSubsidy         = 50 * constants.SompiPerKarlsen
	defaultDeflationaryPhaseBaseSubsidy            = 44 * constants.SompiPerKarlsen
