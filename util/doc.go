...
A Block defines a karlsen block that provides easier and more efficient
...
A Tx defines a karlsen transaction that provides more efficient manipulation of
...
The Address interface provides an abstraction for a karlsen address. While the
most common type is a pay-to-pubkey, karlsen already supports others and
...
To decode/encode an address:
	...
	addrString := "karlsen:qqj9fg59mptxkr9j0y53j5mwurcmda5mtza9n6v9pm9uj8h0wgk6uma5pvumr"
	defaultPrefix := util.Bech32PrefixKarlsen
