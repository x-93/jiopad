	...
	tests := []struct {
		...
		// Positive P2PK tests.
		{
			...
			f: func() (util.Address, error) {
				publicKey := []byte{
					...
					0xe3, 0x4c, 0xce, 0x70, 0xc8, 0x63, 0x73, 0x27, 0x3e, 0xfc,
					0xe3, 0x4c}
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixKarlsen)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixKarlsen,
		},
		{
			name:    "mainnet p2pk 2",
			...
			passedPrefix:   util.Bech32PrefixKarlsen,
			expectedPrefix: util.Bech32PrefixKarlsen,
		},
		{
			name:    "testnet p2pk",
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixKarlsenTest)
			},
			passedPrefix:   util.Bech32PrefixKarlsenTest,
			expectedPrefix: util.Bech32PrefixKarlsenTest,
		},
		...
		// ECDSA P2PK tests.
		{
			...
			f: func() (util.Address, error) {
				publicKey := []byte{
					...
					0xe3, 0x4c, 0xce, 0x70, 0xc8, 0x63, 0x73, 0x27, 0x3e, 0xfc,
					0xe3, 0x4c, 0xaa}
				return util.NewAddressPublicKeyECDSA(publicKey, util.Bech32PrefixKarlsen)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixKarlsen,
		},
		...
		// Positive P2SH tests.
		{
			...
			f: func() (util.Address, error) {
				script := []byte{
					...
					0xae}
				return util.NewAddressScriptHash(script, util.Bech32PrefixKarlsen)
			},
			passedPrefix:   util.Bech32PrefixKarlsen,
			expectedPrefix: util.Bech32PrefixKarlsen,
		},
		{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixKarlsen)
			},
			passedPrefix:   util.Bech32PrefixKarlsen,
			expectedPrefix: util.Bech32PrefixKarlsen,
		},
		{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixKarlsenTest)
			},
			passedPrefix:   util.Bech32PrefixKarlsenTest,
			expectedPrefix: util.Bech32PrefixKarlsenTest,
		},
...
func TestParsePrefix(t *testing.T) {
	tests := []struct {
		...
		{"karlsen", util.Bech32PrefixKarlsen, false},
		{"karlsentest", util.Bech32PrefixKarlsenTest, false},
		{"karlsensim", util.Bech32PrefixKarlsenSim, false},
...
func TestPrefixToString(t *testing.T) {
	tests := []struct {
		...
		{util.Bech32PrefixKarlsen, "karlsen"},
		{util.Bech32PrefixKarlsenTest, "karlsentest"},
		{util.Bech32PrefixKarlsenSim, "karlsensim"},
		{util.Bech32PrefixUnknown, ""},
	}
